...
\includegraphics[width=.0666\linewidth]{accuracy_size.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_fullsize.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_crop.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_mean.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_std.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_conv1_kernel_size.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_conv1_dim.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_conv2_kernel_size.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_conv2_dim.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_stride1.pdf} 
%\includegraphics[width=.0666\linewidth]{accuracy_stride2.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_dimension.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_lr.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_momentum.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_batch_size.pdf} 
\includegraphics[width=.0666\linewidth]{accuracy_epochs.pdf} 
